    ...
    <section id="enterprise" className="relative py-32 px-4">
      <div className="mx-auto max-w-[960px]">
        ...
        >
          ...
          <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[400px] h-[200px] bg-foreground/[0.015] rounded-full blur-[80px] pointer-events-none" />
          ...
          <div className="relative p-8 sm:p-12 lg:p-16 xl:p-20">
            <div className="max-w-md">
              ...
              <h2 className="text-[clamp(1.6rem,3.5vw,2.5rem)] font-bold tracking-[-0.04em] text-foreground leading-[1.05] mb-5">
                Built for serious
                <br />
                <span className="text-foreground/15">traders and teams</span>
              </h2>
              <p className="text-foreground/20 text-[14px] leading-[1.7] mb-10 font-medium">
                From solo traders to institutional teams &mdash; the infrastructure to build, test, and deploy at scale.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mb-10">
              {capabilities.map((c) => (
                <div
                  key={c.text}
                  className="flex items-center gap-2 rounded-[10px] px-3 py-2 text-[11px] text-foreground/25 bg-foreground/[0.02] border border-foreground/[0.03] font-semibold"
                >
                  <span className="text-foreground/12">{c.icon}</span>
                  {c.text}
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2.5">
              ...
              <a
                href="#"
                className="inline-flex items-center justify-center rounded-[12px] border border-foreground/[0.05] bg-foreground/[0.02] px-6 py-[10px] text-[12px] font-semibold text-foreground/25 hover:text-foreground/50 hover:border-foreground/[0.08] transition-all duration-300"
              >
                Documentation
              </a>
            </div>

      ...
      <div className="mx-auto max-w-[1080px]">
        ...
        >
          <h2 className="text-[clamp(2rem,5.5vw,4rem)] font-bold tracking-[-0.05em] text-foreground leading-[0.95] mb-5">
            Prompt. Backtest.
            <br />
            <span className="text-foreground/15">Deploy.</span>
          </h2>
          <p className="text-foreground/20 text-[14px] max-w-[320px] mx-auto font-medium">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5">
          {features.map((f, i) => (
            <motion.div
              ...
              className={`group relative rounded-[18px] border border-foreground/[0.04] bg-foreground/[0.012] p-6 hover:border-foreground/[0.08] transition-all duration-500 overflow-hidden ${f.span || ""}`}
            >
              {f.accent && (
                <div
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-[14px] font-semibold text-foreground/75 mb-1.5 tracking-[-0.01em]">
                  {f.title}
                </h3>
                <p className="text-[12px] text-foreground/20 leading-[1.6] font-medium">
                  {f.description}
                </p>
              </div>
            </motion.div>
